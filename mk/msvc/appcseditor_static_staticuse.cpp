...
SCF_USE_STATIC_PLUGIN(cameramanager)
SCF_USE_STATIC_PLUGIN(csbmpimg)
SCF_USE_STATIC_PLUGIN(cscegui)
SCF_USE_STATIC_PLUGIN(csddsimg)
SCF_USE_STATIC_PLUGIN(cseditorcomponents)
SCF_USE_STATIC_PLUGIN(cseditorcore)
SCF_USE_STATIC_PLUGIN(cseditorheaders)
SCF_USE_STATIC_PLUGIN(cseditormenus)
SCF_USE_STATIC_PLUGIN(cseditoroperators)
SCF_USE_STATIC_PLUGIN(cseditorpanels)
SCF_USE_STATIC_PLUGIN(cseditorspaces)
